      ...
      <div className="w-full max-w-4xl">
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
            ...
            <button
                ...
                className={`p-2 px-4 rounded-lg text-white text-sm sm:text-base whitespace-nowrap transition-colors ${isFavorite(recipe.id) ? 'bg-red-500 hover:bg-red-600' : 'bg-green-500 hover:bg-green-600'}`}
            >
        ...
        <div className="mt-8 max-w-3xl text-left">
            ...
            <div className="mt-4 p-6 rounded-lg bg-white dark:bg-gray-800 border dark:border-gray-200 dark:border-gray-700 shadow-sm">
                <p className="whitespace-pre-line leading-relaxed text-gray-800 dark:text-gray-200">{recipe.instructions}</p>
            </div>
        </div>
      </div>
    </main>
